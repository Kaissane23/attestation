...
<form style="margin-left:20%;margin-right:20%; margin-top:30px;" method="POST" action="pdf_licence.php">
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Filière</label>
    <input type="text" class="form-control" id="exampleInputEmail1" name="filiere" aria-describedby="emailHelp">
  </div>
